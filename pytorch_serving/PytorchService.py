...
class PytorchInferenceService:
    ...
    def __init__(self, model_name, model_base_path, use_cuda=False, version=-1):
        """
        :param model_name:
    ...
    def inference(self, version, input_data):
        ...
        if self.match_metadata(input_data, self.model_metadata[self.model_version2id[model_version]]) is 0:
